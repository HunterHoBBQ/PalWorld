<script>
	...
	// import logo from '$lib/images/.png';
</script>

<Footer footerType="socialmedia" class="mt-10">
	<div class="md:flex md:justify-between">
		<div class="mb-6 md:mb-0">
			<!-- <FooterBrand href="https://JoyGlob.com" src={logo} alt="Pals World Logo" name="Pals World" /> -->
		</div>
		<div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
			<div>
				...
				<FooterLinkGroup>
					<FooterLink liClass="mb-4" href="/">Pals World</FooterLink>
					<FooterLink liClass="mb-4" href="/">Apply Job</FooterLink>
				</FooterLinkGroup>
			</div>
			<div>
	...
	<div class="sm:flex sm:items-center sm:justify-between">
		<FooterCopyright href="/" by="Pals World™" />
